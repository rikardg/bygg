...
images, etc. In addition, we had to have quite a lot of Python code to cover
the gaps and set up the repo for different customer configurations between
builds.
...
I also encountered certain ... resistance from colleagues to want to work in
Make. I think that is mainly due to that the Makefile syntax is a bit archaic,
and working with it and Make's peculiarities requires a certain state of mind.
Using Python could bridge this gap.
